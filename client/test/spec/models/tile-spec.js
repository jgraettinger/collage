...
define([
  ...
  describe('collage/models/tile', function () {
    ...
    it('offers a root tile constructor', function () {
      var photo  = {width: Tile.SIZE * 5, height: Tile.SIZE * 2};
      ...
      photo.width = -1;
      expect(function() { Tile.buildRootTile(photo); }).toThrow(
          'Invalid photo bounds');
    });
    it('supports computing tile pixel bounds', function () {
      var photo = {width: Tile.SIZE * 3, height: Tile.SIZE * 3 - 1};
    ...
    it('supports recursive enumeration of children', function () {
      var photo = {width: Tile.SIZE * 3 - 1, height: Tile.SIZE * 2 + 1},
